...
public class QueryUtils {
    ...
    private  static final String [] CURRENCIES_SHORT_FORM = {"NGN","ETH","GBP","USD","CAD","JPY","CNY","XOF","EUR","INR","AUD","AED",
    "SGD","CHF","ZAR","GHS","ILS","NZD","MYR","BRL","ZWD"};

    private static final String [] CURRENCIES = {"Nigerian Naira", "Ethereum", "British Pounds", "US Dollars", "Canadian Dollars", "Japanese Yen",
    "Chinese Yuan", "West African CFA Francs", "Euro", "Indian Rupees", "Australian Dollars", "United Arab Emirates Dirhams", "Singaporean Dollars",
    "Swiss Francs", "South African Rand", "Ghanaian Cedis", "Israeli New Shekels", "New Zealand Dollars", "Malaysian Ringgit", "Brazillian Reals",
    "Zimbabwean Dollars"};
