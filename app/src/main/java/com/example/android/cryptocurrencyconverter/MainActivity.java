...
import com.example.android.cryptocurrencyconverter.utilities.ConverterAdapter;
import com.example.android.cryptocurrencyconverter.utilities.RatesLoader;
...
public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<ArrayList<Rate>>, ConverterAdapter.ConverterAdapterOnClickHandler{
    ...
    private static final String CRYPTOCOMPARE_URL
            ...
            "&tsyms=NGN,ETH,GBP,USD,CAD,JPY,CNY,XOF,EUR,INR,AUD,AED,SGD,CHF,ZAR,GHS,ILS,NZD,MYR,BRL,ZWD";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*
         * This setting is to improve performance if you know that changes in content do not
         * change the child layout size in the RecyclerView
         */
    ...
    void refreshItems(){
        //Restart loader manager Already disposed: Module: 'app'
